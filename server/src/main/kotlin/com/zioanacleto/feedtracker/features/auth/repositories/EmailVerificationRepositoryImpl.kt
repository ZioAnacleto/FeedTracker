...
class EmailVerificationRepositoryImpl : EmailVerificationRepository {
    ...
    override suspend fun replaceActiveCode(email: String, codeHash: String, expiresAt: Long, createdAt: Long): EmailVerificationCode =
        transactionDb {
    ...
    override suspend fun findActiveByEmail(email: String): EmailVerificationCode? = transactionDb {
