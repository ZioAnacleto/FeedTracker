...
class FeedTrackerApiClient(
    ...
    suspend fun getTrackingSessions(): List<TrackingSessionModel> =
        execute { httpClient.get(trackingSessionsUrl) }

    suspend fun getTrackingSession(id: String): TrackingSessionModel =
        execute { httpClient.get("$trackingSessionsUrl/$id") }

    suspend fun createTrackingSession(request: CreateTrackingSessionRequest): TrackingSessionModel =
        execute {
